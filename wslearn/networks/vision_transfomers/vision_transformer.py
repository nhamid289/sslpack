...
class VisionTransformer(nn.Module):
    ...
    def _resize_pos_embed_vit(self, posemb, posemb_new, num_tokens=1, gs_new=()):
...
class ViT_Tiny_2(VisionTransformer):
    ...
    def __init__(
        self, image_size, in_channels, num_classes, pretrained=False, **kwargs
    ):
        ...
        if pretrained is True:
            self.load_checkpoint(
                "https://github.com/microsoft/Semi-supervised-learning/releases/download/v.0.0.0/vit_tiny_patch2_32_mlp_im_1k_32.pth"
            )
...
class ViT_Small_2(VisionTransformer):
    ...
    def __init__(
        ...
        if pretrained is True:
            self.load_checkpoint(
                "https://github.com/microsoft/Semi-supervised-learning/releases/download/v.0.0.0/vit_small_patch2_32_mlp_im_1k_32.pth"
            )
